...
public class InvoiceClientModel implements InvoiceDAO {

    //Constant for the client's invoices table
    public static final String TABLE_INVOICE_CLIENT = "invoiceclient";
    ...
    public List<Invoice> queryInvoices() {
        ...
        try (PreparedStatement statement = Datasource.getInstance().getConnection().prepareStatement(QUERY_INVOICES);
    ...
    public int insertInvoice() throws SQLException {
        ...
        if (affectedRows != 1) {
            ...
            throw new SQLException("Couldn't insert invoice!");
        }
